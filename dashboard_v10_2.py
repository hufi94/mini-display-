# Cyberpunk Dashboard – PCB v10.2 (Fixed Civic Animation – No Ghosting, Transparent)
# Full script version (ready to run)
...
# Path to Civic PNG frames (exported with transparency)
FRAMES_DIR = "/home/matteo94/Desktop/cd/civic_frames"
...
class FramePlayerWidget(QLabel):
    ...
    def load_dir(self, dir_path):
        ...
        self.frames = [QImage(f).convertToFormat(QImage.Format_ARGB32_Premultiplied)
                       for f in files]
        self.idx = 0
        if self.frames:
            self._paint_current()
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.grid_timer.timeout.connect(self.update)
